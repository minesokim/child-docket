...
| # | Decision | Locked | Why |
|---|---|---|---|
| L1 | **Path 2 commitment**: Docket is the orchestration platform that runs the firm's AI tax stack. Public API + MCP server ship in v1, not v1.5. NOT just "AI-native PM with Path 2 hooks." | 2026-05-09 | Path 2 is the swing-for-unicorn bet; Path 1 is the floor. Hybrid is worst-of-both. |

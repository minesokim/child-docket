...
//     can render its own discreet "× Exit" button on the left side
//     of the progress-bar row. The /welcome page doesn't render
//     IntakeHeader, so no sign-out button shows there (intentional).
//

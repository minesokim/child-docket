...
| C12 /scan landing page | ⬜ Queued (next) | Marketing surface for the Discovery Scan funnel per `docs/landing-pages/discovery-scan-landing-copy.md`. UI work — needs `/craft` skill compliance. Editorial-warm tone matching the rest of client-portal. |
